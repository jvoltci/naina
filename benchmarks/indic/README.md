...
Apple M5 Pro, naina 0.2.1, alphabet `devanagari`, 2026-09-23. chrF++ higher
...
|---|---|---|---|---|---|---|
| **small, raw** | **76.6** | 6.1 | 0.0 | 0.3 | 0 | 106 |
| small, pad 0.5 | 74.5 | 6.9 | 0.0 | 0.0 | 0 | 109 |
| medium, pad 0.5 | 74.0 | 7.1 | 0.0 | 0.0 | 0 | 233 |
| tiny, pad 0.5 | 71.8 | 8.4 | 0.0 | 1.0 | 1 | 33 |
| medium, raw | 49.8 | 49.2 | 20.0 | 45.3 | 135 | 223 |
| tiny, raw | 6.9 | 91.8 | 100.0 | 91.7 | 258 | 26 |
...
at 106 ms a crop, reads real printed Devanagari better than an 8-billion
...
raw and recover with a margin (tiny 6.9 to 71.8, medium 49.8 to 74.0), small
...
newspapers. The per-crop times were taken while other work ran on the
machine (a Vite build and a headless Chrome audit), so they are indicative,
not the three-run medians the rest of this repository publishes.
...
**Corrected 2026-09-24.** The Mac took a macOS update overnight (26.5.2 to
27.0) between this table and the detector resampler fix that followed it
(the lab's private note on the detector resampler (2026-09-23)), and the OS update
alone moves naina's OmniDocBench numbers, so every row here was rechecked.
Small, unchanged code: chrF++ 76.39 under macOS 27, against 76.6 above; the
ranking against the paper's table does not move. Medium's detector filter
changed from bilinear to triangle in the fix; measured old against new code,
both under macOS 27, on these same 300 crops: raw chrF++ 49.78 to 51.11 (10 of
300 predictions changed, 4 fewer empties), padded chrF++ 74.01 to 73.52 (17 of
300 changed). Tiny and small keep bilinear, so their rows cannot move from the
fix. Devanagari sits near the resampler's effect on OmniDocBench, in either
direction, not inside it.
